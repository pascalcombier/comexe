...
local WndClassSize = LibFFI.sizeof(WndClassExType)
local RectSize = LibFFI.sizeof(RectType)
local MessageSize = LibFFI.sizeof(MessageType)
local PaintStructSize = LibFFI.sizeof(PaintStructType)
assert(WndClassSize)
assert(RectSize)
assert(MessageSize)
